package com.example.rfideinlessen;
...
public class MainViewModel extends AndroidViewModel {
    ...
    private String ByteArrayToHexString(final byte[] inarray) {
        Log.d(ContentValues.TAG, "ByteArrayToHexString " + Arrays.toString(inarray));
        int i, j, in;
    ...
    public String getByteArrayToHexString(final byte[] inarray) {
        Log.d(TAG, "getByteArrayToHexString " + Arrays.toString(inarray));
